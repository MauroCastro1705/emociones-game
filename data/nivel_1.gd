...
const RESPUESTAS := {
	"inicio": {
		"pregunta": "Estás con tus amigos en un recreo en la clase. Nazarena, una compañera de clase pasa cerca de ustedes y empieza a molestar a uno de tus amigos",
		"opciones": [
			"Ignorar la situación",
			"",
			"Actuas agresivamente",
			"Actuas para ayudar"
		],
	...
	"naranja_intervenis": {
		"pregunta": "La mirás a Nazarena y le pedís que por favor deje de molestar",
		"opciones": ["Continuar3", "", "", ""],
		"next": ["continuar3", "", "", ""]
	},

	"rojo_intervenis": {
		"pregunta": "Ya tuviste problemas con Nazarena en el pasado, la enfrentás diciendo que se vaya",
		"opciones": ["Continuar4", "", "", ""],
		"next": ["continuar4", "", "", ""]
	},

	"continuar": {
		"pregunta": "Nazarena sigue molestando a tu amigo y este no parece defenderse, sino que se pone nervioso y está intimidado",
		"opciones": [
			"",
			"Tratar de hablar con Nazarena",
			"Actuas diciendo un insulto",
			""
		],
	...
	"continuar3": {
		"pregunta": "\"No te metas gil\". Nazarena te insulta",
		"opciones": [
			"",
			"Tratar de hablar con Nazarena",
	...
	"continuar1": {
		"pregunta": "Nazarena te mira y te dice que no te metas mientras sigue molestando a tu amigo",
		"opciones": [
			"",
			"Avisar a un adulto",
			"",
			"Actuas con un insulto"
		],
		"next": ["", "verde_aviso", "", "naranja_insulto"]
	},

	"continuar2": {
		"pregunta": "Nazarena te mira y se ríe. Deja de molestar a tu amigo pero esto va a tener repercusiones después de clases",
	...
	"continuar4": {
		"pregunta": "Nazarena te mira de manera agresiva y parece que te va a pegar",
		"opciones": [
			"",
			"",
			"ROJO Lo empujás",
	...
	"rojo_empujas": {
		"pregunta": "Nazarena te devuelve el empujón y te caés al piso, el profesor los frena y los manda a direccion",
	...
	"rojo_piña": {
		"pregunta": "Le das una trompada en la cara a Nazarena y le dejás la nariz sangrando",
		"opciones": ["", "", "", "Continuar6"],
		"next": ["", "", "", "continuar6"]
	},

	"continuar5": {
		"pregunta": "Nazarena te mira con enojo y tristeza",
		"opciones": [
			"Tratás de razonar",
			"",
	...
	"resultado6": {
		"pregunta": "Ambos están en dirección, Nazarena tiene la nariz rota y deciden suspenderte una semana",
		"opciones": ["Continuar", "", "", ""],
		"next": ["", "", "", ""],
		"final": true,
	}
